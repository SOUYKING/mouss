...
class api:
    ...
    def init(self):
        ...
        post_data = {
            ...
            "ver": encryption.encrypt("1.0", "650956f31c88ebd624b4d6e37d2b52e849731162a8a60129b0c201aae95f91d2", init_iv),
            "hash": self.hash_to_check,
            "enckey": encryption.encrypt(self.enckey, "650956f31c88ebd624b4d6e37d2b52e849731162a8a60129b0c201aae95f91d2", init_iv),
            "name": binascii.hexlify("aimassist".encode()),
            "ownerid": binascii.hexlify("2rmycUeNGK".encode()),
            "init_iv": init_iv
        }
        ...
        response = encryption.decrypt(response, "650956f31c88ebd624b4d6e37d2b52e849731162a8a60129b0c201aae95f91d2", init_iv)
